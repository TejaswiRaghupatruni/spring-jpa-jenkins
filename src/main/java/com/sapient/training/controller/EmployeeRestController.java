...
public class EmployeeRestController {
	...
	@ApiOperation(value="create employee", response= Employee.class , tags="create-emp")
	...
	@ApiOperation(value="get all employes", response= Employee.class , tags="get-all-emp")
	...
	@ApiOperation(value="get employes of given job & salary more than given value ", response= Employee.class , tags="get-more-than-sal")
	...
	@ApiOperation(value="get employee by id", response= Employee.class , tags="get-emp-by-id")
